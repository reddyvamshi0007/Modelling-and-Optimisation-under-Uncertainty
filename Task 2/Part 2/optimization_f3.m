% F3: Optimize Rosenbrock's Function using GA, PSO, and SA
clc;
clear;
...
% Display results
disp(['F3 (Rosenbrock) - GA Best: ', num2str(ga_best), ', Avg: ', num2str(ga_avg), ', Std: ', num2str(ga_std)]);
disp(['F3 (Rosenbrock) - PSO Best: ', num2str(pso_best), ', Avg: ', num2str(pso_avg), ', Std: ', num2str(pso_std)]);
disp(['F3 (Rosenbrock) - SA Best: ', num2str(sa_best), ', Avg: ', num2str(sa_avg), ', Std: ', num2str(sa_std)]);