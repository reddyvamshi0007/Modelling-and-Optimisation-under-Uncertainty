% F1: Optimize Ackley's Function using GA, PSO, and SA
clc;
clear;
...
% Display results
disp(['F1 (Ackley) - GA Best: ', num2str(ga_best), ', Avg: ', num2str(ga_avg), ', Std: ', num2str(ga_std)]);
disp(['F1 (Ackley) - PSO Best: ', num2str(pso_best), ', Avg: ', num2str(pso_avg), ', Std: ', num2str(pso_std)]);
disp(['F1 (Ackley) - SA Best: ', num2str(sa_best), ', Avg: ', num2str(sa_avg), ', Std: ', num2str(sa_std)]);